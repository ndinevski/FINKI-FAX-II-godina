...
def edit_dataset(dataset, index_column):
    data = []
...
if __name__ == '__main__':
    ...
    dataset = edit_dataset(dataset, index_column)
    ...
    classifier = RandomForestClassifier(criterion=crit, n_estimators=trees, random_state=0)
