...
def valid_move(snake,snake_head):
    if snake_head in snake or snake_head[0] < 0 or snake_head[1] < 0 or snake_head[0] > 9 or snake_head[1] > 9:
        return False
    return True

def go_forward(snake, snake_head, direction, green_apples):
    new_snake = []
    part = snake_head
    ...
    if snake_head in green_apples:
        ...
        return tuple(new_snake),direction, tuple(green_apples)
