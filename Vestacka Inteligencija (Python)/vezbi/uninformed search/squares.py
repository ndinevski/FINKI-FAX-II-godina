...
class Squares(Problem):
    ...
    def successor(self, state):
        ...
        for i in range(len(squares)):
            ...
            new_square = (squares[i][0] - 1, squares[i][1])
            if self.check_valid(new_square):
                new_squares[i] = new_square
                succ["Pomesti kvadratche {} levo".format(i+1)] = tuple(new_squares)
            ...
            if self.check_valid(new_square):
                new_squares[i] = new_square
                succ["Pomesti kvadratche {} desno".format(i+1)] = tuple(new_squares)

            # gore
            new_squares = list(squares[:])
            new_square = (squares[i][0], squares[i][1]+1)
            if self.check_valid(new_square):
                new_squares[i] = new_square
                succ["Pomesti kvadratche {} gore".format(i+1)] = tuple(new_squares)
            ...
            if self.check_valid(new_square):
                new_squares[i] = new_square
                succ["Pomesti kvadratche {} dolu".format(i+1)] = tuple(new_squares)
