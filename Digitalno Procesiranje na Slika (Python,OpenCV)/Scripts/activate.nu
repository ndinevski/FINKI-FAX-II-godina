...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'D:\Work\Hacking and Programming\Programming\FINKI-FAX-II-godina\FINKI-FAX-II-godina\Digitalno Procesiranje na Slika (Python,OpenCV)'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'D:\Work\Hacking and Programming\Programming\FINKI-FAX-II-godina\FINKI-FAX-II-godina\Digitalno Procesiranje na Slika (Python,OpenCV)\Scripts\deactivate.nu'
